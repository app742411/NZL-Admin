...
useEffect(() => {
  ...
  if (price > END_PRICE) {
    ...
    }, price > 740 ? 600 : 900); // slows near 700
  } else {
    // Pause at lowest price, then restart
    timer = setTimeout(() => {
  ...
  const priceMotion = useTransform(heroProgress, [0.15, 0.35], [800, 750]);
      ...
      <div className="relative z-10 mx-auto flex min-h-[110vh] max-w-7xl flex-col items-center px-6 pt-24 text-center">
        ...
        >
          <motion.span
            ...
            className="inline-block font-700"
          >
            Beat the Clock,
          </motion.span>
          <br />
          ...
          <motion.div style={{ y: phoneY }} className="relative z-20">
            <div className="relative w-[360px]">
              <div className="absolute inset-[12px] z-10 overflow-hidden rounded-[32px]">
                <img
                  src="/images/image/countdown.png"
  ...
  className="absolute left-[144px] bottom-[210px] z-10 text-center text-4xl font-bold text-brand-500 coundown"
>
  SAR <br /> {price}
</motion.h1>
